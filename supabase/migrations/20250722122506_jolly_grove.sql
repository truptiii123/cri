...
-- Insert comprehensive Indian cities data (500+ cities)
INSERT INTO `cities` (`state`, `city_name`, `district`, `pincode`) VALUES
-- Andhra Pradesh
...
CREATE TABLE `couriers` (
  ...
  `to_party_name` varchar(100) DEFAULT NULL,
  `from_party_name` varchar(100) DEFAULT NULL,
...
INSERT INTO `couriers` (`courier_id`, `to_party_name`, `from_party_name`, `party_name`, `mobile`, `address`, `from_city`, `to_city`, `delivery_date`, `amount`, `status`, `remarks`, `agent_id`) VALUES
('RAJE1001', 'Rajesh Electronics Delhi', 'Rajesh Electronics Mumbai', 'Rajesh Electronics', '9876543210', '123 Main Street, Andheri', 'Mumbai', 'Delhi', '2024-01-15', 1500.00, 'in_transit', 'Fragile items - Handle with care', 'AGT001'),
('PRIY2001', 'Priya Textiles Bangalore', 'Priya Textiles Delhi', 'Priya Textiles', '9876543211', '456 Market Road, Connaught Place', 'Delhi', 'Bangalore', '2024-01-16', 2500.00, 'pending', 'Express delivery required', 'AGT002'),
('AMIT3001', 'Amit Traders Chennai', 'Amit Traders Bangalore', 'Amit Traders', '9876543212', '789 Commercial Street, MG Road', 'Bangalore', 'Chennai', '2024-01-17', 1800.00, 'delivered', 'Standard delivery completed', 'AGT003');
...
CREATE INDEX idx_couriers_date ON couriers(created_at);
CREATE INDEX idx_couriers_status_date ON couriers(status, created_at);
CREATE INDEX idx_tracking_courier_time ON tracking(courier_id, timestamp);
CREATE INDEX idx_agents_status ON agents(status);
CREATE INDEX idx_cities_state_city ON cities(state, city_name);
